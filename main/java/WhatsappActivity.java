...
import com.example.mystorysaver.databinding.ActivityWhatsappBinding;
import com.example.mystorysaver.fragments.ImageFragment;
import com.example.mystorysaver.fragments.VideoFragment;
...
public class WhatsappActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        for (int i = 0; i< binding.tabLayout.getTabCount(); i++){
             @SuppressLint("InflateParams") TextView tv = (TextView) LayoutInflater.from(activity)
